...
<body>
<form id="idFormAioCheckOut" method="post" action="ECPay_Stored.php">
    ...
    <label class="col-xs-12">描述 (TradeDesc):
        <input type="text" name="TradeDesc" value="儲值金額" class="form-control"/>
    </label>
    <label class="col-xs-12">名稱 (ItemName):
        <input type="text" name="ItemName" value="儲值金額" class="form-control"/>
        <!-- 商品名稱以符號 # 分 -->
    </label>
